...
module.exports = AtomSmartTemplate =
  ...
  activate: (state) ->
    ...
    unless fsPlus.existsSync( path.join(@templatesRoot, "GenericPuppetModule") )
      fsPlus.copySync( path.join(@assetsRoot, "GenericPuppetModule"), path.join(@templatesRoot, "GenericPuppetModule") )
